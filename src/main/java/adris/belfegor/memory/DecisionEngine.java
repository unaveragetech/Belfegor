...
public class DecisionEngine {
     ...
     */
    public String decideItemAcquisition(Belfegor mod, String itemName, Item item) {
     ...
     */
    public Item decideBestTool(Belfegor mod, String jobType) {
     ...
     */
    public List<Item> decideToolProgression(Belfegor mod) {
    ...
    private double getNearestBlockDistance(Belfegor mod, Item item) {
    ...
    private double getNearestMaterialDistance(Belfegor mod, Item item) {
        return 20;
    }

    private double getNearestChestDistance(Belfegor mod, Item item) {
    ...
    private double getNearestDropDistance(Belfegor mod, Item item) {
        return 64;
    }

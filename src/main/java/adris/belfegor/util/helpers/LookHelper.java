...
public interface LookHelper {
     ...
     */
    static Vec3d getCameraPos(Belfegor mod) {
     ...
     */
    static boolean tryAvoidingInteractable(Belfegor mod) {
     ...
     */
    private static boolean isCollidingInteractable(Belfegor mod) {
     ...
     */
    static void randomOrientation(Belfegor mod) {
     ...
     *
     * @param mod      The instance of the Belfegor class.
     ...
     */
    static boolean isLookingAt(Belfegor mod, Rotation rotation) {
     ...
     */
    static boolean isLookingAt(Belfegor mod, BlockPos pos) {
     ...
     *
     * @param mod      The instance of Belfegor.
     * @param rotation The desired rotation to look at.
     * @param withBaritone Whether to use Baritone to look.
     */
    static void lookAt(Belfegor mod, Rotation rotation, boolean withBaritone) {
        if (withBaritone) {
     ...
     * @param rotation The desired rotation to look at.
     */
    static void lookAt(Belfegor mod, Rotation rotation) {
        // Update the target rotation in the LookBehavior
        mod.getClientBaritone().getLookBehavior().updateTarget(rotation, true);
     ...
     */
    static void lookAt(Belfegor mod, Vec3d toLook, boolean withBaritone) {
     ...
     * @throws IllegalArgumentException if mod or toLook is null.
     */
    static void lookAt(Belfegor mod, Vec3d toLook) {
        if (mod == null || toLook == null) {
            throw new IllegalArgumentException("mod and toLook cannot be null");
        }
     ...
     * @param withBaritone Whether to use Baritone to look.
     */
    static void lookAt(Belfegor mod, BlockPos toLook, Direction side, boolean withBaritone) {
     ...
     * @param side   The direction to look from.
     */
    static void lookAt(Belfegor mod, BlockPos toLook, Direction side) {
        // Calculate the center coordinates of the target location
        double centerX = toLook.getX() + 0.5;
        double centerY = toLook.getY() + 0.5;
        double centerZ = toLook.getZ() + 0.5;
     ...
     * @param withBaritone Whether to use Baritone to look.
     */
    static void lookAt(Belfegor mod, BlockPos toLook, boolean withBaritone) {
     ...
     * @param toLook The block position to look at.
     */
    static void lookAt(Belfegor mod, BlockPos toLook) {
     ...
     */
    static Rotation getLookRotation(Belfegor mod, Vec3d toLook) {
     ...
     */
    static Rotation getLookRotation(Belfegor mod, BlockPos toLook) {

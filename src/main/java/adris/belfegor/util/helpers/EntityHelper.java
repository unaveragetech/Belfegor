...
import adris.belfegor.ItemInfo.ArmorToughnessUtility;
...
public class EntityHelper {
    ...
    public static boolean isAngryAtPlayer(Belfegor mod, Entity entity) {
        return isGenerallyHostileToPlayer(mod, entity);
    }

    public static boolean isGenerallyHostileToPlayer(Belfegor mod, Entity entity) {

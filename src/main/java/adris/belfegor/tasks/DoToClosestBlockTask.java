...
public class DoToClosestBlockTask extends AbstractDoToClosestObjectTask<BlockPos> {
    ...
    @Override
    protected Vec3d getPos(Belfegor mod, BlockPos obj) {
        return WorldHelper.toVec3d(obj);
    }

    @Override
    protected Optional<BlockPos> getClosestTo(Belfegor mod, Vec3d pos) {
        if (_getClosest != null) {
    ...
    @Override
    protected boolean isValid(Belfegor mod, BlockPos obj) {

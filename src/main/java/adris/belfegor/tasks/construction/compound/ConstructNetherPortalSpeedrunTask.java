package adris.belfegor.tasks.construction.compound;

import adris.belfegor.Belfegor;
import adris.belfegor.Debug;
import adris.belfegor.TaskCatalogue;
import adris.belfegor.tasks.InteractWithBlockTask;
import adris.belfegor.tasks.construction.ClearLiquidTask;
 ...
 */
public class ConstructNetherPortalSpeedrunTask extends adris.belfegor.tasksystem.Task {
    ...
    private final adris.belfegor.tasksystem.Task _collectLavaTask = TaskCatalogue.getItemTask(Items.LAVA_BUCKET, 1);
    ...
    @Override
    protected adris.belfegor.tasksystem.Task onTick(Belfegor mod) {
    ...
    @Override
    protected void onStop(Belfegor mod, adris.belfegor.tasksystem.Task interruptTask) {
        mod.getBlockTracker().stopTracking(Blocks.LAVA);
        mod.getBehaviour().pop();
    }

    @Override
    protected boolean isEqual(adris.belfegor.tasksystem.Task other) {
    ...
    private BlockPos findLavaLake(Belfegor mod) {
    ...
    private static class LavaTarget {
        ...
        private adris.belfegor.tasksystem.Task placeTask(BlockPos portalOrigin, boolean below) {

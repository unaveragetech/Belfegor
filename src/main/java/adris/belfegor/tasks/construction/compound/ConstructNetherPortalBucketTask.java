...
import adris.belfegor.tasks.construction.PlaceObsidianBucketTask;
...
public class ConstructNetherPortalBucketTask extends Task {
    ...
    private BlockPos findLavaLake(Belfegor mod, BlockPos playerPos) {
    ...
    private BlockPos getPortalableRegion(Belfegor mod, BlockPos lava, BlockPos playerPos, Vec3i sizeOffset, Vec3i sizeAllocation, int timeoutRange) {

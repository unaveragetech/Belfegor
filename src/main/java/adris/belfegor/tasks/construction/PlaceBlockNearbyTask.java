...
public class PlaceBlockNearbyTask extends Task {
    ...
    private boolean blockEquipped(Belfegor mod) {
        return StorageHelper.isEquipped(mod, ItemHelper.blocksToItems(_toPlace));
    }

    private boolean place(Belfegor mod, BlockPos targetPlace) {
    ...
    private void stopPlacing(Belfegor mod) {
    ...
    private BlockPos locateClosePlacePos(Belfegor mod) {
        int range = 7;
        BlockPos best = null;

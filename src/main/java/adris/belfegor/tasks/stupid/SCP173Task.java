...
public class SCP173Task extends Task {
    ...
    private boolean isSeenByPlayer(Belfegor mod) {
    ...
    private boolean entityIsLookingInOurGeneralDirection(Belfegor mod, PlayerEntity other) {
    ...
    private boolean entityHasLineOfSightToUs(Belfegor mod, PlayerEntity other) {

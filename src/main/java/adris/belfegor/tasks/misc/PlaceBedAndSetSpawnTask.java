...
import adris.belfegor.eventbus.events.GameOverlayEvent;
...
public class PlaceBedAndSetSpawnTask extends Task {
     ...
     */
    private BlockPos locateBedRegion(Belfegor mod, BlockPos origin) {
     ...
     */
    private boolean isGoodPosition(Belfegor mod, BlockPos pos) {
     ...
     */
    private boolean isGoodToPlaceInsideOrClear(Belfegor mod, BlockPos pos) {
     ...
     */
    private boolean isGoodAsBorder(Belfegor mod, BlockPos pos) {

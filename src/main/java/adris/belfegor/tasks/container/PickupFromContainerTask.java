...
public class PickupFromContainerTask extends AbstractDoToStorageContainerTask implements ITaskCanForce {
    ...
    public static Optional<Slot> getBestSlotToTransfer(Belfegor mod, ItemTarget itemToMove, int currentItemQuantity, List<Slot> grabPotentials, Function<ItemStack, Boolean> canStackFit) {

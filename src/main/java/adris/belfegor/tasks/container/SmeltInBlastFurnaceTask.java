...
import adris.belfegor.tasks.resources.CollectFuelTask;
...
import adris.belfegor.util.slots.BlastFurnaceSlot;
...
public class SmeltInBlastFurnaceTask extends ResourceTask {
    ...
    static class DoSmeltInBlastFurnaceTask extends DoStuffInContainerTask {
        ...
        private void tryUpdateOpenBlastFurnace(Belfegor mod) {

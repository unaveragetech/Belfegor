...
import adris.belfegor.tasks.entity.AbstractKillEntityTask;
...
public class KillEnderDragonTask extends Task {
    ...
    private static Task getPickupTaskIfAny(Belfegor mod, Item... itemsToPickup) {
    ...
    private BlockPos locateExitPortalTop(Belfegor mod) {
    ...
    private class PunkEnderDragonTask extends Task {
        ...
        private void stopHitting(Belfegor mod) {
            if (_wasHitting) {
        ...
        private BlockPos getRandomWanderPos(Belfegor mod) {

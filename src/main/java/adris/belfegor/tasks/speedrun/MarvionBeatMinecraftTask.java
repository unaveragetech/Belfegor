...
import adris.belfegor.tasks.container.*;
import adris.belfegor.tasks.misc.EquipArmorTask;
import adris.belfegor.tasks.misc.LootDesertTempleTask;
import adris.belfegor.tasks.misc.PlaceBedAndSetSpawnTask;
import adris.belfegor.tasks.misc.SleepThroughNightTask;
import adris.belfegor.tasks.movement.*;
import adris.belfegor.tasks.resources.*;
import adris.belfegor.tasksystem.Task;
import adris.belfegor.trackers.BlockTracker;
import adris.belfegor.trackers.EntityTracker;
import adris.belfegor.util.Dimension;
import adris.belfegor.util.ItemTarget;
import adris.belfegor.util.MiningRequirement;
import adris.belfegor.util.SmeltTarget;
...
public class MarvionBeatMinecraftTask extends Task {
     ...
     */
    private static boolean isEndPortalFrameFilled(Belfegor mod, BlockPos pos) {
    ...
    /**
     * Check if the task should be forced for the given Belfegor mod.
     * @param mod the Belfegor mod
     * @param task the task to check
     * @return true if the task should be forced, false otherwise
     */
    private static boolean shouldForce(Belfegor mod, Task task) {
     ...
     */
    private boolean needsBuildingMaterials(Belfegor mod) {
     ...
     * @param mod The Belfegor mod
     */
    private void updateCachedEndItems(Belfegor mod) {
     ...
     */
    private boolean hasItemOrDroppedInEnd(Belfegor mod, Item item) {
     ...
     */
    private List<Item> lootableItems(Belfegor mod) {
     ...
     */
    private boolean endPortalFound(Belfegor mod, BlockPos endPortalCenter) {
     ...
     */
    private boolean endPortalOpened(Belfegor mod, BlockPos endPortalCenter) {
        // Check if the end portal is already opened and the center position is provided
     ...
     */
    private boolean spawnSetNearPortal(Belfegor mod, BlockPos endPortalCenter) {
     ...
     */
    private Optional<BlockPos> locateClosestUnopenedRuinedPortalChest(Belfegor mod) {
    ...
    /**
     * Pushes the behaviour of the given Belfegor object.
     *
     * @param mod the Belfegor object
     */
    private void pushBehaviour(Belfegor mod) {
     ...
     * @param mod The Belfegor mod instance.
     */
    private void addThrowawayItemsWarning(Belfegor mod) {
     ...
     * @param mod The Belfegor mod instance.
     */
    private void trackBlocks(Belfegor mod) {
    ...
    /**
     * Adds protected items to the specified Belfegor mod.
     *
     * @param mod the Belfegor mod to add protected items to
     */
    private void addProtectedItems(Belfegor mod) {
     ...
     * @param mod The Belfegor mod instance
     */
    private void allowWalkingOnEndPortal(Belfegor mod) {
     ...
     * @param mod the Belfegor mod instance
     */
    private void avoidDragonBreath(Belfegor mod) {
     ...
     * @param mod The Belfegor mod instance
     */
    private void avoidBreakingBed(Belfegor mod) {
     ...
     */
    private Task setSpawnNearPortalTask(Belfegor mod) {
     ...
     */
    private Task getBlazeRodsTask(Belfegor mod, int count) {
     ...
     */
    private Task getEnderPearlTask(Belfegor mod, int count) {
     ...
     *
     * @param mod The Belfegor instance.
     * @return The target number of beds.
     */
    private int getTargetBeds(Belfegor mod) {
    ...
    /**
     * Check if the given Belfegor mod needs more beds based on the item count and cached end item drops.
     *
     * @param mod The Belfegor mod to check.
     * @return True if more beds are needed, false otherwise.
     */
    private boolean needsBeds(Belfegor mod) {
     ...
     */
    private Task getBedTask(Belfegor mod) {
     ...
     */
    private boolean anyBedsFound(Belfegor mod) {
     ...
     */
    private BlockPos doSimpleSearchForEndPortal(Belfegor mod) {
     ...
     */
    private int getFilledPortalFrames(Belfegor mod, BlockPos endPortalCenter) {
     ...
     */
    private boolean canBeLootablePortalChest(Belfegor mod, BlockPos blockPos) {
    ...
    private Task getEyesOfEnderTask(Belfegor mod, int targetEyes) {

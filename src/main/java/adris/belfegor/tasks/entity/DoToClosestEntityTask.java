...
public class DoToClosestEntityTask extends AbstractDoToClosestObjectTask<Entity> {
    ...
    @Override
    protected Vec3d getPos(Belfegor mod, Entity obj) {
        return obj.getPos();
    }

    @Override
    protected Optional<Entity> getClosestTo(Belfegor mod, Vec3d pos) {
    ...
    @Override
    protected boolean isValid(Belfegor mod, Entity obj) {

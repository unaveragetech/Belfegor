...
import adris.belfegor.tasks.resources.SatisfyMiningRequirementTask;
...
public class PickupDroppedItemTask extends AbstractDoToClosestObjectTask<ItemEntity> implements ITaskRequiresGrounded {
    ...
    public static boolean isIsGettingPickaxeFirst(Belfegor mod) {
    ...
    private boolean isAnnoying(Belfegor mod, BlockPos pos) {
        if (annoyingBlocks != null && mod.getWorld() != null) {
    ...
    @Override
    protected Vec3d getPos(Belfegor mod, ItemEntity obj) {
    ...
    @Override
    protected Optional<ItemEntity> getClosestTo(Belfegor mod, Vec3d pos) {
    ...
    @Override
    protected boolean isValid(Belfegor mod, ItemEntity obj) {

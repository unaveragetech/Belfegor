...
public class CollectCropTask extends ResourceTask {
    ...
    private boolean isEmptyCrop(Belfegor mod, BlockPos pos) {
    ...
    private boolean isMature(Belfegor mod, BlockPos blockPos) {

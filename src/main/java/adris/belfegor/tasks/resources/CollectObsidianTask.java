...
public class CollectObsidianTask extends ResourceTask {
    ...
    private static BlockPos getGoodObsidianPosition(Belfegor mod) {
    ...
    @Override
    protected adris.belfegor.tasksystem.Task onResourceTick(Belfegor mod) {
    ...
    @Override
    protected void onResourceStop(Belfegor mod, adris.belfegor.tasksystem.Task interruptTask) {

...
public abstract class Task {
     ...
     */
    public void stop(Belfegor mod, Task interruptTask) {
        if (!_active) return;
     ...
     */
    public void interrupt(Belfegor mod, Task interruptTask) {
        if (!_active) return;
    ...
    protected abstract void onStart(Belfegor mod);

    protected abstract Task onTick(Belfegor mod);

    // interruptTask = null if the task stopped cleanly
    protected abstract void onStop(Belfegor mod, Task interruptTask);

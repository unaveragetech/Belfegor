...
import adris.belfegor.eventbus.events.BlockPlaceEvent;
import adris.belfegor.memory.LocationMemory;
import adris.belfegor.trackers.blacklisting.WorldLocateBlacklist;
...
public class BlockTracker extends Tracker {
    ...
    public BlockTracker(Belfegor mod, TrackerManager manager) {
        super(manager);
        _mod = mod;
    ...
    static class PosCache {
        ...
        public void blacklistBlockUnreachable(Belfegor mod, BlockPos pos, int allowedFailures) {
        ...
        public Optional<BlockPos> getNearest(Belfegor mod, Vec3d position, Predicate<BlockPos> isValid, Block... blocks) {
            if (!anyFound(blocks)) {
                return Optional.empty();
            }
         ...
         */
        public void smartPurge(Belfegor mod, Vec3d playerPos) {

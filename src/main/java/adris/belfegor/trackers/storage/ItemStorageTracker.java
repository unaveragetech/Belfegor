package adris.belfegor.trackers.storage;

import adris.belfegor.Belfegor;
import adris.belfegor.Debug;
import adris.belfegor.trackers.Tracker;
import adris.belfegor.trackers.TrackerManager;
import adris.belfegor.util.ItemTarget;
import adris.belfegor.util.helpers.StorageHelper;
import adris.belfegor.util.slots.*;
...
public class ItemStorageTracker extends Tracker {
    ...
    public ItemStorageTracker(Belfegor mod, TrackerManager manager, Consumer<ContainerSubTracker> containerTrackerConsumer) {
        super(manager);

...
import adris.belfegor.butler.WhisperChecker;
import adris.belfegor.tasks.CraftGenericManuallyTask;
import adris.belfegor.tasks.construction.PlaceBlockNearbyTask;
import adris.belfegor.tasks.construction.PlaceSignTask;
import adris.belfegor.tasks.construction.PlaceStructureBlockTask;
import adris.belfegor.tasks.construction.compound.ConstructIronGolemTask;
import adris.belfegor.tasks.construction.compound.ConstructNetherPortalObsidianTask;
...
import adris.belfegor.tasks.examples.ExampleTask2;
import adris.belfegor.tasks.misc.EquipArmorTask;
import adris.belfegor.tasks.misc.PlaceBedAndSetSpawnTask;
import adris.belfegor.tasks.misc.RavageDesertTemplesTask;
import adris.belfegor.tasks.misc.RavageRuinedPortalsTask;
import adris.belfegor.tasks.movement.*;
import adris.belfegor.tasks.resources.CollectBlazeRodsTask;
import adris.belfegor.tasks.resources.CollectFlintTask;
import adris.belfegor.tasks.resources.CollectFoodTask;
import adris.belfegor.tasks.resources.TradeWithPiglinsTask;
import adris.belfegor.tasks.speedrun.KillEnderDragonTask;
import adris.belfegor.tasks.speedrun.KillEnderDragonWithBedsTask;
import adris.belfegor.tasks.speedrun.WaitForDragonAndPearlTask;
import adris.belfegor.tasks.stupid.BeeMovieTask;
import adris.belfegor.tasks.stupid.ReplaceBlocksTask;
import adris.belfegor.tasks.stupid.SCP173Task;
import adris.belfegor.tasks.stupid.TerminatorTask;
 ...
 * https://github.com/adrisj7-Belfegor/Belfegor/pull/7#discussion_r641792377
...
public class Playground {
    ...
    public static void IDLE_TEST_INIT_FUNCTION(Belfegor mod) {
        // Test code here
    ...
    public static void IDLE_TEST_TICK_FUNCTION(Belfegor mod) {
        // Test code here
    }

    public static void TEMP_TEST_FUNCTION(Belfegor mod, String arg) {
        //mod.runUserTask();

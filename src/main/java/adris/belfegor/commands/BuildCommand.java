...
public class BuildCommand extends Command {
    ...
    public String getDetailedDescription() {
        return "Expands the remembered home base. Use @build full to build and validate "
                ...
                + "into Belfegor, parse it into the internal blueprint format, create a staging chest near the build site, "
                + "source every required block material in game, deposit it into the staging chest, and then build the full structure from the sourced materials, remembering it at the player's current origin. "

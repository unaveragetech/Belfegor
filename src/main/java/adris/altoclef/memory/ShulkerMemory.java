...
public class ShulkerMemory {
    ...
    public List<ShulkerEntry> findItem(Item item) {
        String name = adris.altoclef.util.helpers.ItemHelper.stripItemName(item);
    ...
    public int getTotalItemCount(Item item) {
        return getTotalItemCount(adris.altoclef.util.helpers.ItemHelper.stripItemName(item));
    }
    ...
    public boolean hasItem(Item item) {
        return hasItem(adris.altoclef.util.helpers.ItemHelper.stripItemName(item));
    }

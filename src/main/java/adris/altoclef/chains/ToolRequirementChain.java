...
public class ToolRequirementChain extends SingleTaskChain {
    ...
    private final adris.altoclef.util.time.TimerGame _checkTimer = new adris.altoclef.util.time.TimerGame(2);
     ...
     */
    private ToolSetTask.Tier determineNeededTier(AltoClef mod) {
     ...
     */
    private boolean hasToolTier(AltoClef mod, String prefix) {

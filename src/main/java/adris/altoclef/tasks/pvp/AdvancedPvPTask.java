...
public class AdvancedPvPTask extends Task {
    ...
    private Task doGearPhase(AltoClef mod) {
    ...
    private Task doSeekPhase(AltoClef mod, Optional<PlayerEntity> target) {
        if (target.isPresent()) {
        ...
        return new adris.altoclef.tasks.movement.TimeoutWanderTask(60);
    }

    private Task doEngagePhase(AltoClef mod, Optional<PlayerEntity> target, float health, float absorption) {
        if (target.isEmpty()) {
            _phase = Phase.SEEK;
    ...
    private Task doFallbackPhase(AltoClef mod, float health, float absorption) {
    ...
    private Task doHealPhase(AltoClef mod, float health, float absorption) {
    ...
    private Task doResumePhase(AltoClef mod, Optional<PlayerEntity> target) {
    ...
    private Task eatGoldenApple(AltoClef mod) {
    ...
    private Task eatEnchantedApple(AltoClef mod) {
    ...
    private Optional<PlayerEntity> findTarget(AltoClef mod) {
    ...
    private boolean hasBestSword(AltoClef mod) {
    ...
    private boolean isFullyArmored(AltoClef mod) {
    ...
    private Task getArmorTask(AltoClef mod) {
    ...
    private int getBuildingBlockCount(AltoClef mod) {
        int count = 0;
    ...
    private Vec3d findSafeFallbackPosition(AltoClef mod) {
